...
STRINGS = {
    "ru": {
        ...
        "st_ready": "Готов — заберите!",
        "st_done": "Выдан. Приятного аппетита!",
    ...
    "kz": {
        ...
        "add_wish": "тағамға тілек",
        "save": "Сақтау",
        "skip": "Өткізіп жіберу",
        "add_to_cart": "Себетке қосу",
        "promo_code": "Промокод (бар болса)",
        "st_new": "Тапсырыс қабылданды",
        "st_confirmed": "Расталды",
        "st_preparing": "Дайындалуда",
        "st_ready": "Дайын — алып кетіңіз!",
        "st_done": "Берілді. Ас болсын!",
        "st_cancelled": "Бас тартылды",
    ...
    "en": {
        ...
        "promo_code": "Promo code (if any)",
        "st_new": "Order received",
        "st_confirmed": "Confirmed",
        "st_preparing": "Being prepared",
        "st_ready": "Ready — pick it up!",
        "st_done": "Served. Enjoy!",
